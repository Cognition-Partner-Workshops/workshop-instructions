...
19 showcases across application-development, data-engineering, devops-platform, migration, and security. Tree: [`demos/`](../demos/). One Packet per demo, `packetType: Demo`, `audience: [Sales, Solutions]`. These are linear "follow along" scripts, not labs.
