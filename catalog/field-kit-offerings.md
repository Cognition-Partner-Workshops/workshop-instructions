...
15 showcases across application-development, data-engineering, migration, security, and testing-qa. Tree: [`demos/`](../demos/). One Packet per demo, `packetType: Demo`, `audience: [Sales, Solutions]`. These are linear "follow along" scripts, not labs.
