...
| 4 | **Demos** | Facilitator-led linear showcases, persona-targeted | 19 (5 categories) | `Demo` | Sales, Solutions | 200 |
...
19 showcases across application-development, data-engineering, engineering-leadership, migration, and security. Tree: [`demos/`](../demos/). One Packet per demo, `packetType: Demo`, `audience: [Sales, Solutions]`. These are linear "follow along" scripts, not labs.
