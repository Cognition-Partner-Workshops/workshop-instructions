...
| 4 | **Demos** | Facilitator-led linear showcases, persona-targeted | 16 (5 categories) | `Demo` | Sales, Solutions | 200 |
...
16 showcases across data-engineering, migration, security, application-development, and ai-ml (counting `demos/security/general.md` once; its `.local`/`.platform` files are variants). Tree: [`demos/`](../demos/). One Packet per demo, `packetType: Demo`, `audience: [Sales, Solutions]`. These are linear "follow along" scripts, not labs.
